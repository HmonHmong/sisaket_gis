...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 12, 2026 at 03:39 AM
...
INSERT INTO `projects` (`id`, `project_name`, `fiscal_year`, `distance`, `width`, `has_shoulder`, `shoulder_width`, `area`, `budget_amount`, `budget_type`, `budget_detail`, `start_lat`, `start_long`, `end_lat`, `end_long`, `status`, `created_by`, `created_at`) VALUES
(1, 'ทดสอบซ่อมถนนหินคลุก', 2568, 501.00, 5.00, 0, 0.00, 2505.00, 499000.00, 'statute', NULL, 14.54978500, 104.78003400, 14.54699500, 104.77826200, 'รอนุมัติ', NULL, '2026-01-08 03:20:56');
...
INSERT INTO `project_points` (`id`, `project_id`, `village`, `moo`, `sub_district`, `district`, `province`, `order_index`) VALUES
(2, 1, 'บ้านบก', NULL, 'โพนข่า', 'เมืองศรีสะเกษ', 'ศรีสะเกษ', 0);
...
(1, 'admin', '$2a$12$zk8PKOASddu96PjkItPoFu9JyLOZMeoC4gg4.BoVElSsBKyKtcss2', 'ผู้ดูแลระบบสำนักช่าง', 'วิศวกรโยธาชำนาญการ', 'สำนักช่าง', 'admin', 'active', '2026-01-08 14:07:24', '2026-01-08 03:56:11');
